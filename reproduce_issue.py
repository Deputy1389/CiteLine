    ...
    try:
        ...
        mock_events = [
            Event(
                ...
                date=EventDate(value=date(2005, 11, 21), original_text="2005-11-21"),
                facts=[Fact(text="Acetaminophen 325 MG Oral Tablet")],
                provider_id="p1"
            ),
             Event(
                event_id="e2", # Vitals heavy
                event_type=EventType.INPATIENT_DAILY_NOTE,
                date=EventDate(value=date(2016, 2, 25), original_text="2016-02-25"),
                facts=[
                    Fact(text="Body Height: 162.8 cm"),
                    Fact(text="Body Weight: 73.8 kg"), 
                    Fact(text="Pain severity - 0-10"),
                    Fact(text="Acetaminophen 325 MG")
                ],
                provider_id="p1"
            ),
             Event(
                ...
                date=EventDate(value=date(2005, 11, 21), original_text="2005-11-21"),
                facts=[Fact(text="Labs found: Hemoglobin, Hematocrit")],
                provider_id="p1"
            )
        ]
